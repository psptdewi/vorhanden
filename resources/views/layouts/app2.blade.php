  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav" style="background-image: url({{asset('img/app1.jpg')}});">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Data Karyawan">
          <a class="nav-link" href="{{ url('/admin/presensi/show') }}">
            <i class="fa fa-fw fa-table"></i>
            <span class="nav-link-text">Data Presensi</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Grafik">
          <a class="nav-link" href="{{ url('/admin/presensi/grafik') }}">
            <i class="fa fa-fw fa-area-chart"></i>
            <span class="nav-link-text">Grafik</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Cuti">
          <a class="nav-link" href="{{ url('/admin/presensi/cuti') }}">
